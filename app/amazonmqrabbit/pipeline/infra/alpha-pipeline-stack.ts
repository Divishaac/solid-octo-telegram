...
export class AlphaPipelineStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        const alpha_pipeline = new CodePipeline(this, 'alpha-Pipeline', {
            ...
            pipelineName: 'amazonmqrabbit-alpha-pipeline',
        ...
        const alpha_stage = alpha_pipeline.addStage( new AmazonmqrabbitPipelineStage(this, 'Deploy_to_alpha', { env: alpha_env}, 'alpha'));
